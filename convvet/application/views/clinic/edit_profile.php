...
<body>
    ...
    <div class="container">
        ...
        <div class="profile-header">
            ...
            <form action="<?php echo site_url('clinic_dashboard/upload_foto'); ?>" method="post"
        ...
        <div class="edit-form">
            ...
            <form action="<?php echo site_url('clinic_dashboard/update_profile'); ?>" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="cnpj" id="cnpj" value="<?php echo $user->cnpj; ?>" class="form-control">
                </div>
                <div class="form-actions">
                    <button type="submit" class="btn-custom">Salvar Alterações</button>
